...
(1, 6, 'Muhammad Idris Saefaturahnmah,S.H', 200000000, 'Lunas', 'awe', '2025-12-14 12:14:11');
...
CREATE TABLE `tabel_kalender` (
  ...
  `tipe` enum('meeting','task','appointment','deadline','presentation','custom') DEFAULT 'custom',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(7, 'Muhamad Darus Salam,S.H', 'MDSREKAN@GMAIL.COM', '082211922701', 'JL. PAJELERAN GUNUNG RT. 003 RW. 005', 'S1', '5', 'STIS Darul Ulum Lampung Timur', '2', '1765703193_42f96e1918ba4f4b9a4e.png', '2025-12-14 02:04:33', '2025-12-14 02:06:33', NULL);
...
(1, 'admin', '$2y$10$vTFEraCRhfAzL0yjviuxb.fWkZwV.YAFeTIkar2enOvirBAZeHHoC', 'admin@example.com', '1', '2025-11-28 01:11:23', 'light', 'Silahkan yang kang kalau mau di update ', 0, '2025-12-14 12:19:52');
...
ALTER TABLE `tabel_barcode`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `barcode` (`barcode`) USING HASH;
