...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2025 at 09:42 PM
...
INSERT INTO `kontak` (`id`, `name`, `email`, `subject`, `message`, `is_read`, `created_at`) VALUES
(19, 'FIRMA HUKUM MDS DAN REKAN', 'MDSREKAN@GMAIL.COM', 'okoko', 'lklklk', 1, '2025-12-04 03:11:52'),
(20, 'FIRMA HUKUM MDS DAN REKAN', 'MDSREKAN@GMAIL.COM', 'okoko', 'lklklklkl', 0, '2025-12-04 03:17:04');

-- --------------------------------------------------------

--
-- Table structure for table `tabel_barcode`
--

CREATE TABLE `tabel_barcode` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tabel_barcode`
--

INSERT INTO `tabel_barcode` (`id`, `nama_pengacara`, `barcode`, `spesialis`, `latitude`, `longitude`, `link_profile`, `no_hp`, `lokasi_maps`, `foto`, `created_at`, `updated_at`) VALUES
(9, '6', 'https://api.qrserver.com/v1/create-qr-code/?data=http%3A%2F%2Flocalhost%3A8080%2Fprofile%2F9&size=150x150', 'asdasdas', -6.4914246, 106.809731, 'http://localhost:8080/profile/9', '21312312312321', 'Nuansa Alam Residence Sukahati, Sukahati, Bogor, West Java, Java, 16913, Indonesia', 0x313736353635373436325f66323562656339663963363231316136653561362e706e67, '2025-12-13 13:24:22', '2025-12-13 13:24:22');
...
(1, '1764785900_bc87e6c78294789cdb8c.png', 'Firma Hukum MDS Dan Rekan', 'Firma Hukum MDS dan Rekan menyediakan layanan hukum terpercaya meliputi litigasi, non-litigasi, hukum bisnis, perdata, pidana, properti, dan perburuhan. Berpengalaman, responsif, dan berorientasi pada hasil.', 'MDS dan Rekan, MDS Legal Services, Firma Hukum MDS, pengacara wilayah Bogor, pengacara wilayah Cianjur, pengacara wilayah Bandung Barat, kantor advokat Bogor, kantor advokat Cianjur, kantor advokat Bandung Barat, praktisi hukum Bogor, praktisi hukum Cianjur, praktisi hukum Bandung Barat, layanan hukum Bogor, layanan hukum Cianjur, layanan hukum Bandung Barat, konsultan hukum Bogor, konsultan hukum Cianjur, konsultan hukum Bandung Barat, ahli hukum perdata Bogor, spesialis hukum pidana Cianjur, pengacara korporasi Bandung Barat.', '2022 @ Copyright Firma Hukum MDS Dan Rekan', 0, '2025-11-30 07:26:39', '2025-12-04 15:13:24');
...
(1, 'admin', '$2y$10$vTFEraCRhfAzL0yjviuxb.fWkZwV.YAFeTIkar2enOvirBAZeHHoC', 'admin@example.com', 'admin', '2025-11-28 01:11:23', 'light', 'Silahkan yang kang kalau mau di update ', 0, '2025-12-05 04:15:13'),
...
--
-- Indexes for table `tabel_barcode`
--
ALTER TABLE `tabel_barcode`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `tabel_barcode`
--
ALTER TABLE `tabel_barcode`
